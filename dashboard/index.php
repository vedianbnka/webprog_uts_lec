    ...
    <body class="bg-gray-100">
        ...
        <section class="bg-transparent py-20 relative mt-2">
            <div class="container mx-auto px-4 text-center relative z-10">
                <h1 class="text-4xl font-bold text-white mt-7">
                    Experience the Best Concerts
                </h1>
                <p class="text-white mt-4">Your hub for live music events.</p>
                <a href="events.php">
                    <button
                        class="mt-6 px-6 py-3 bg-[#7B61FF] text-white rounded-md shadow-lg hover:bg-[#6A52E0]">
                        Get Started
                    </button>
                </a>
            </div>
        ...
        <!-- Content Section -->
        <section class="container mx-auto p-5 bg-white rounded shadow" id="konten">
            ...
            <div class="relative">
                <!-- Navigation Buttons -->
                <button
                    class="absolute left-0 top-1/2 transform -translate-y-1/2 bg-[#7B61FF] text-white p-2 rounded-full shadow hover:bg-[#6A52E0] z-10"
                    onclick="slideLeft()">
                    &#10094;
                </button>
                <button
                    class="absolute right-0 top-1/2 transform -translate-y-1/2 bg-[#7B61FF] text-white p-2 rounded-full shadow hover:bg-[#6A52E0] z-10"
                    onclick="slideRight()">
                    &#10095;
                </button>
                ...
                <div
                    id="event-slider"
                    class="flex overflow-x-auto scroll-smooth gap-5 mx-auto w-full max-w-5xl px-5 pb-5">
                    <?php while($row = $resultEvents->fetch(PDO::FETCH_ASSOC)): ?>
                    <div
                        class="flex-shrink-0 w-80 relative flex flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
                        <div class="relative h-40 overflow-hidden rounded-t-xl bg-gray-300">
                            <?php if ($row['banner_event']): ?>
                            <img
                                src="../upload/<?= htmlspecialchars($row['banner_event']) ?>"
                                alt="banner_event"
                        ...
                        <div class="p-6">
                            <h2
                                class="mb-2 text-xl font-bold leading-snug tracking-normal text-[#7B61FF] antialiased">
                            ...
                            <p
                                ...
                                <strong>Waktu:</strong>
                                <?= htmlspecialchars($row['waktu']) ?><br>
                                <strong>Lokasi:</strong>
                                <?= htmlspecialchars($row['lokasi']) ?><br>
                        ...
                        <div class="p-6 pt-0">
                            <a
                                href="regis.php?id_event=<?= htmlspecialchars($row['id_event']) ?>"
                                class="select-none rounded-lg bg-[#7B61FF] py-3 px-6 text-center font-sans text-xs font-bold uppercase text-white shadow-md transition-all hover:bg-[#7B61FF]/90">
                                Register
                            </a>
                        </div>
                    </div>
        ...
        <?php else: ?>
            ...
            <div class="text-center mt-5 mb-6">
                <br>
                <a
                    href="events.php?limit=<?= $limit + 6 ?>"
                    class="mt-6 px-6 py-3 bg-[#7B61FF] text-white rounded-md shadow-lg hover:bg-[#6A52E0]">See More ></a>
                <br>
            </div>
            <?php endif; ?>
        </section>
