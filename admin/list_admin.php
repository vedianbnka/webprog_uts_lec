    ...
    <div class="flex flex-col lg:flex-row">
        ...
        <header class="bg-white shadow p-4 flex justify-between items-center">
            ...
            <main class="p-6 bg-gray-100">
                ...
                <?php endif; ?>
                    <button class="bg-[#7B61FF] hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white">
                            <thead class="bg-[#7B61FF] text-white">
                                <tr>
                                    <th class="py-3 px-6 text-left text-sm font-semibold uppercase tracking-wider border-b border-[#7B61FF]">ID Admin</th>
