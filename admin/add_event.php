        ...
        <div>
            ...
            <main class="flex-1 p-4">
                ...
                <form
                    ...
                    method="POST"
                    class="bg-white p-4 border rounded shadow max-w-lg mx-auto mt-10"
                        ...
                        <div id="cat1-fields" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <input
                                    ...
                                    id="cat1-harga"
                                    name="cat1_harga"
                                    placeholder="Harga CAT 1"
                                    class="w-full px-2 py-1 border rounded"/>
                                <input
                                    type="number"
                                    id="cat1-kuota"
                                    name="cat1_kuota"
                                    placeholder="Kuota CAT 1"
                                    class="w-full px-2 py-1 border rounded"/>
                            </div>
                        </div>
                        ...
                        <div id="cat2-fields" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <input
                                    ...
                                    id="cat2-harga"
                                    name="cat2_harga"
                                    placeholder="Harga CAT 2"
                                    class="w-full px-2 py-1 border rounded"/>
                                <input
                                    type="number"
                                    id="cat2-kuota"
                                    name="cat2_kuota"
                                    placeholder="Kuota CAT 2"
                                    class="w-full px-2 py-1 border rounded"/>
                            </div>
                        </div>
                        ...
                        <div id="cat3-fields" class="hidden">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                                <input
                                    ...
                                    id="cat3-harga"
                                    name="cat3_harga"
                                    placeholder="Harga CAT 3"
                                    class="w-full px-2 py-1 border rounded"/>
                                <input
                                    type="number"
                                    id="cat3-kuota"
                                    name="cat3_kuota"
                                    placeholder="Kuota CAT 3"
                                    class="w-full px-2 py-1 border rounded"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-4 text-center">
                        <button
                            type="submit"
                            class="bg-[#7B61FF] hover:bg-[#6A52E0] text-white px-4 py-2 rounded"
                            id="submit-btn">Add Event</button>
                    </div>
                </form>
            </main>
            <script>
