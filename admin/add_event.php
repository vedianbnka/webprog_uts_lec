...
<div class="flex flex-col lg:flex-row">
    ...
    <div class="flex-1">
        ...
        <form action="add_event_proses.php" method="POST" class="p-5 border rounded bg-white shadow animasi" enctype="multipart/form-data">
            <h1 class="text-center text-2xl font-semibold">Add Event</h1>
            ...
            <div class="form-group">
                ...
                <input type="text" id="nama_event" name="nama_event" class="form-control" required="required" autocomplete="off"/>
            </div>

            <div class="form-group">
                <label for="tanggal">Tanggal</label>
                <input type="date" id="tanggal" name="tanggal" class="form-control" required="required" autocomplete="off"/>
            </div>

            <div class="form-group">
                <label for="waktu">Waktu</label>
                <input type="time" id="waktu" name="waktu" class="form-control" required="required" autocomplete="off"/>
            </div>

            <div class="form-group">
                <label for="lokasi">Lokasi</label>
                <input type="text" id="lokasi" name="lokasi" class="form-control" required="required" autocomplete="off"/>
            </div>
