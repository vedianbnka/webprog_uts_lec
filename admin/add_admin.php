    ...
    <body class="bg-gray-100">
        <div>
            ...
            <main class="flex-1 p-4">
                ...
                <form
                    action="add_admin_proses.php"
                    method="POST"
                    class="space-y-3 bg-white p-4 rounded-lg shadow-md max-w-md mx-auto mt-7">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="nama"
                            autocomplete="off"
                            class="w-full px-3 py-1.5 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-[#7B61FF] focus:border-transparent">
                    </div>
                    ...
                    <div>
                        <input
                            type="submit"
                            value="Sign Up"
                            class="w-full bg-[#7B61FF] text-white font-semibold py-2 rounded hover:bg-[#6A52E0] focus:outline-none focus:ring-2 focus:ring-[#7B61FF] focus:ring-offset-2 cursor-pointer">
                    </div>
                </form>
