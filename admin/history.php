            ...
            <main class="flex-1 p-4">
                ...
                <main class="p-6 bg-gray-100">
                    ...
                    <section class="bg-white p-6 rounded-lg shadow-lg mb-8">
                        <h3 class="text-xl font-semibold text-black mb-4">List History Partisipan
                            <?php echo $user['nama']; ?></h3>
                        <button
                            class="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">
                            <a
                                href="excel_history.php?id_user=<?= $id_user ?>"
                                class="text-white-700 hover:underline">Download Excel</a>
                        </button>
                        <div class="table-responsive mt-4 overflow-x-auto">
                            <table
                                id="tabell"
                                class="display w-full min-w-[600px] bg-white shadow-lg rounded-lg overflow-hidden">
                                ...
                                <tbody class="divide-y divide-transparent">
                                    <!-- Add this class to remove borders -->
                                    <?php
