                        ...
                        <div class="overflow-x-auto">
                            <table class="min-w-full bg-white">
                                <thead class="bg-[#7B61FF] text-white">
                                    <tr>
                                        <th
                                            class="py-3 px-6 text-left text-sm font-semibold uppercase tracking-wider border-b border-[#7B61FF]">ID User</th>
                                        <th
                                    ...
                                    <tr>
                                        ...
                                        <td class="py-4 px-6 text-sm border-b border-[#7B61FF]">
                                            <a
                                                ...
                                                data-event-id="<?= $row['id_user'] ?>">Delete User</a>

                                            <!-- Form yang akan dikirim saat event dihapus -->
                                            <form
                                                id="deleteForm_<?= $row['id_user'] ?>"
                                                action="delete_user.php?id_user=<?= $row['id_user'] ?>"
                                                method="POST"
                                                style="display:none;">
                                                <input type="hidden" name="id_user" value="<?= $row['id_user'] ?>">
                                            </form>
                                            <a
                                                href="history.php?id_user=<?= $row['id_user'] ?>"
                                                class="text-blue-500 hover:text-blue-700 border-[#7B61FF] ml-4">History Partisipan</a>
                                        </td>
                                    </tr>
                                    <?php
                                    }
